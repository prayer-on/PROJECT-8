...
const backendProject = () => {
 window.open("https://github.com/prayer-on/PROJECT-6.git", "_blank");
    ...
    return (
        <main>
        <Card name= "KASA" image_card= {Project_React} description= "A responsive frontend web application for property rentals. I used a JSON file to handle data dynamically and React Router to provide modern, seamless navigation between pages without refreshing, while leveraging Sass to ensure a clean and organized codebase."/>
